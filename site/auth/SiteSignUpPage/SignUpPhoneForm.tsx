...
const initialValues: Values = { phone: '', country: { _id: '', name: '', phone_code: '', iso2: '' } };
...
export const SignUpPhoneForm = (props: SignUpPhoneFormProps) => {
    ...
    const { moveTo, updateSessionId, updateMobileNumber, updateCountryCode } = useSignUpFormFlow();
        ...
        async (values: Values, helpers: FormikHelpers<Values>) => {
            ...
            try {
                ...
                if (mountedRef.current) {
                    ...
                    updateMobileNumber(`+${values.country.phone_code}${values.phone}`);
                    updateCountryCode(values.country.iso2);
                    moveTo('verify-code');
                }
            } catch (e) {
                setSubmitting(false);
