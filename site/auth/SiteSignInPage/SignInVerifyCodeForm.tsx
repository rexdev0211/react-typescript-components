...
import { SignInFormFlowItemProps } from './SignInFormFlowProvider';
import { useSignInFormFlow } from './SignInFormFlowContext';
...
export type SignInVerifyCodeFormProps = React.ComponentPropsWithoutRef<'form'> & SignInFormFlowItemProps;

export const SignInVerifyCodeForm = (props: SignInVerifyCodeFormProps) => {
    const { moveTo, sessionId, updateVerifyCode } = useSignInFormFlow();
